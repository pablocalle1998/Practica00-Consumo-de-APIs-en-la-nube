...
//vamos a definir variables las cuales van a obtener datos de la respuesta a nuestra peticion, esto con la finalidad de
  ...
  if(titulo==""){
    ...
    xmlhttp.onreadystatechange = function(){
      if(this.readyState == 4 && this.status == 200){
        ...
        // movie => es una funcion lambda para obtener el objeto de la respuesta
